...
# fname = '2_3_3_1_20140421T151732_1_small_graph_OD_dense.mat'
...
with pm.Model() as model:
    ...
    x_blocks = [Dirichlet('x%d' % i,np.array([alpha]*(x[0])), shape=x[0]) for (i,x) in \
    ...
    b = [Normal('b%s' % i,mu=mu, tau=10,observed=b_obsi[0]) for \
